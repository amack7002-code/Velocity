...
velo.run(function()
	...
	local soundMap: table = {
		["chair roll"] = {"ChairRolling.mp3", "https://raw.githubusercontent.com/amack7002-code/Velocity/main/assets/ChairRolling.mp3"},
		["chair fly"] = {"ChairFlying", "https://raw.githubusercontent.com/amack7002-code/Velocity/main/assets/ChairFlying.mp3"},
	};
...
velo.run(function()
		...
		local CROSSHAIR_URL: string = "https://raw.githubusercontent.com/amack7002-code/Velocity/refs/heads/main/libraries/crosshair.lua";
        --=========================================================
        --  CONFIG MIRROR
        --
